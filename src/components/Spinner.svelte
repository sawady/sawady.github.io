<style>
  ...
  .ldio-9tlse08bmp div {
    ...
    top: 24px;
    position: absolute;
    animation: ldio-9tlse08bmp linear 1s infinite;
    background: #f5c037;
    width: 6px;
    height: 12px;
  ...
  .loadingio-spinner-spinner-mghhvh2tp3 {
    width: 80px;
    height: 80px;
  ...
  .ldio-9tlse08bmp div { box-sizing: content-box; }
</style>

<div class="loadingio-spinner-spinner-mghhvh2tp3">
  <div class="ldio-9tlse08bmp">
